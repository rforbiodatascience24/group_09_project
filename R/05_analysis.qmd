...
From the PCoA plot we can see that there aren't clusters for each BMI category and some samples overlapp with samples from different categories such as undefinedu
